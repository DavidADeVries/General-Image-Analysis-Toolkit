...
messageLine1 = char(strcat('The patient ID of the current patient is', {' '}, patientId)); 
...
handle = msgbox({messageLine1; messageLine2}, title, icon, 'modal'); %handle used for waiting
